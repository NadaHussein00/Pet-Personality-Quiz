...
# This class represents the base class for the quiz.
# It handles loading questions, options, and trait descriptions based on the quiz type.
...
class Quiz:
    ...
    def load_questions(self, filename):
        questions_file = open(f"{filename}", 'r', encoding='utf-8')
    ...
    def load_descriptions(self,filename):
        descriptions = {}
        descriptions_file = open(f"{filename}", 'r', encoding='utf-8')  
